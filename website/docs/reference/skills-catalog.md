...
| Skill | Description | Path |
|-------|-------------|------|
| [`apple-design`](/docs/user-guide/skills/bundled/creative/creative-apple-design) | Use when designing gesture-driven UI or physical web motion. | `creative/apple-design` |
