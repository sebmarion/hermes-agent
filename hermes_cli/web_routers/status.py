...
async def get_health():
    ...
    from hermes_cli.web_server import _runtime_identity_from_boot_fingerprint
    identity = getattr(app.state, "runtime_identity", None)
    if not isinstance(identity, dict):
        identity = _runtime_identity_from_boot_fingerprint()
    return {"ok": True, "version": __version__, "runtime_identity": identity,
