...
#   - bestplan: execution-plan authoring; reached via /hermes bestplan on
#     Slack. Added at the 50-cap — a native slot would clamp /platform.
...
_SLACK_VIA_HERMES_ONLY = frozenset({"topup", "moa", "debug", "egress", "init", "version", "diff", "update", "heartbeat", "refine", "pause", "whoami", "platform", "review", "bestplan"})
