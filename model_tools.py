...
def _resolve_active_context_length() -> int:
    ...
    try:
        ...
        # their resolvers key off provider/base_url/api_key. Credential
        # resolution failing (offline, no keys) degrades to config values so
        # static provider-aware fallbacks still apply.
