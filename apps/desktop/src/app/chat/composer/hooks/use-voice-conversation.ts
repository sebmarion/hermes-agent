    ...
    async (forceTranscribe = false) => {
      ...
      try {
        ...
        try {
          ...
          // The composer can reject a voice submission when the turn was
          // superseded or the session is no longer writable. Do not enter the
          // speech-response state in that case; otherwise a stale pending
