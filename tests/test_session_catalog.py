...
def test_classify_session_workspace_groups_main_checkout_by_recorded_branch():
    meta = classify_session_workspace(
        "/work/hermes-agent",
        worktree_branch="feature/catalog",
        worktree_repo_root="/work/hermes-agent",
    )

    assert meta["workspace_kind"] == "directory"
    assert meta["workspace_parent_id"] == "/work/hermes-agent"
    assert meta["workspace_group_id"] == "/work/hermes-agent::branch::feature/catalog"
    assert meta["workspace_group_label"] == "feature/catalog"
