...
""" + _UPSERT_KEEP_EXISTING_SQL,
    ...
    def touch_session_activity(
        ...
        provenance: Optional[ActivityProvenance] = None, genuine_activity_at: Optional[float] = None,
    ) -> None:
        ...
        self._write_sql(
            ...
            (
                ...
                normalize_activity_provenance(provenance).value, genuine_activity_at, genuine_activity_at,
