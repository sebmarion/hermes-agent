...
def _(rid, params: dict) -> dict:
    ...
    profile_home = _require_profile_home(profile := (params.get("profile") or "").strip() or None)
...
class _Resume:
    ...
    def __init__(self, rid, params: dict, target: str) -> None:
        ...
        self.profile_home = _require_profile_home(self.profile)
...
def _(rid, params: dict) -> dict:
    ...
    profile_home = _require_profile_home((params.get("profile") or "").strip() or None)
    with _profile_db(params) as db:
        if db is None:
