...
from tui_gateway import owner_delivery as _owner_delivery
_owner_delivery.register(sys.modules[__name__])

from tui_gateway import methods_delivery as _methods_delivery
_methods_delivery.register(sys.modules[__name__])
